...
//            Another way of doing if you don't care about specific errors
    ...
    func addUserToFavorites(user: User) {
        ...
        PersistenceManager.updatedWith(favorite: favorite, actionType: .add) { [ weak self ] error in
            ...
            guard let error = error else {
                DispatchQueue.main.async {
                    self.presentGFAlert(title: "Success!", message: "You have successfully added \(favorite.login) to your favorites 🎉.", buttonTitle: "Hooray!")
                }
                return
            }
            DispatchQueue.main.async {
